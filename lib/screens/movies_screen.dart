          ...
          SliverToBoxAdapter(
            child: Column(
              ...
              children: [
                ...
                _buildSection(context, 'Popular Movies', popularMovies),
                _buildSection(context, 'Top Rated Movies', topRatedMovies),
                _buildSection(context, 'Upcoming Releases', upcomingMovies),
